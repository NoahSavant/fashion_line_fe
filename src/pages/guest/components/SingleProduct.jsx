    ...
    return (
        <div className="flex flex-col w-full justify-start items-center group cursor-pointer animation-iv fade-in overflow-hidden rounded-xl bg-white shadow-full">
            <div className="h-[450px] w-full overflow-hidden relative flex gap-0">
                <img className="w-full h-full object-cover group-hover:-translate-x-full transform transition-transform duration-500 ease-in-out" src={product.first_image} alt={product.name} />
                <img className="w-full h-full object-cover group-hover:-translate-x-full transform transition-transform duration-500 ease-in-out" src={product.second_image} alt={product.name} />
                ...
                <div className="absolute top-0 left-0 p-4 flex flex-col w-full h-full">
                    ...
                    <div className="flex flex-col h-full justify-center gap-2 -mt-[38px]">
                        {product.tags.map((tag, index) => (
                            <a href={`/shop?tags[]=${tag.content}`} key={index} className="px-2 py-1 min-w-[50px] rounded-md w-fit p-btn" style={{ backgroundColor: tag.color }}>
                                <div className="text-base text-white font-semibold text-center">{tag.content}</div>
                            </a>
                        ))}
                    </div>
                </div>
            ...
            <div className="w-full bg-white p-2 flex flex-col">
                ...
                <div className="text-base text-boston_blue font-semibold line-clamp-1">
