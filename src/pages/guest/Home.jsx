...
const Home = () => {
    ...
    return (
        <div className="flex flex-col">
            ...
            {/* Collection */}
            <div className="lg:px-[100px] md:px-[60px] px-5 lg:py-[60px] md:py-[30px] py-5 flex flex-wrap lg:gap-12 md:gap-6 gap-5 relative justify-center">
                {/* <video ref={videoRef} id="heroVideoBg" autoPlay loop muted className="w-full h-full object-cover group-hover:scale-125 transform transition-transform duration-500 ease-in-out absolute top-0 left-0 opacity-70 -z-10">
                ...
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in lg:max-w-72 lg:w-[calc(25%-36px)] md:w-[calc(33.33%-16px)]">
                    <div className="h-[300px] w-full overflow-hidden rounded-b-3xl relative">
                        <img className="w-full h-full object-cover group-hover:scale-125 transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419325/files/parker-burchfield-tvG4WvjgsEY-unsplash_h48a95.jpg" />
                    ...
                    <div className="w-full text-base font-medium text-center bg-white group-hover:bg-sapphire text-sapphire group-hover:text-white px-4 py-2 border-2 border-sapphire rounded-t-3xl transform transition-all duration-500 ease-in-out">
                        collection 1
                    </div>
                </div>
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in lg:max-w-72 lg:w-[calc(25%-36px)] md:w-[calc(33.33%-16px)]">
                    <div className="h-[300px] w-full overflow-hidden rounded-b-3xl relative">
                        <img className="w-full h-full object-cover group-hover:scale-125 transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419325/files/waldemar-NPPNHZK1U0s-unsplash_okve7n.jpg" />
                        <div className="absolute lg:bottom-[-50%] bottom-0 group-hover:bottom-0 transform transition-all duration-500 ease-in-out left-0 w-full h-1/2 overflow-auto bg-black text-white bg-opacity-50 p-4">
                ...
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in lg:max-w-72 lg:w-[calc(25%-36px)] md:w-[calc(33.33%-16px)]">
                    <div className="h-[300px] w-full overflow-hidden rounded-b-3xl relative">
                        <img className="w-full h-full object-cover group-hover:scale-125 transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419325/files/luis-felipe-lins-J2-wAQDckus-unsplash_y9m8lq.jpg" />
                        <div className="absolute lg:bottom-[-50%] bottom-0 group-hover:bottom-0 transform transition-all duration-500 ease-in-out left-0 w-full h-1/2 overflow-auto bg-black text-white bg-opacity-50 p-4">
                ...
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in lg:max-w-72 lg:w-[calc(25%-36px)] md:w-[calc(33.33%-16px)]">
                    <div className="h-[300px] w-full overflow-hidden rounded-b-3xl relative">
                        <img className="w-full h-full object-cover group-hover:scale-125 transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419324/files/benjamin-r-t34i3FBsF90-unsplash_otlc3l.jpg" />
                        <div className="absolute lg:bottom-[-50%] bottom-0 group-hover:bottom-0 transform transition-all duration-500 ease-in-out left-0 w-full h-1/2 overflow-auto bg-black text-white bg-opacity-50 p-4">
            ...
            {/* Videos */}
            <div className="flex flex-col">
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 bg-zircon lg:px-[100px] md:px-[60px] px-5 lg:py-[60px] md:py-[30px] py-5">
                    <div className="flex-col justify-center items-start gap-4 flex animation-iv fade-in-left w-full h-full">
                        <div className="text-sapphire lg:text-[48px] text-4xl font-semibold font-outfit leading-[1]">Summer Fashion Styles</div>
                        <div className="text-boston_blue lg:text-[48px] text-4xl font-semibold font-outfit leading-[1]">Keep You Cool and Chic</div>
                        <div className="text-cinder text-base font-light font-outfit leading-normal">As temperatures rise and days lengthen, refresh your wardrobe with the latest summer fashion styles. Whether at the beach, a garden party, or enjoying a sunny day, these trendy outfits ensure you stay comfortable and stylish</div>
                    </div>
                    <div className="animation-iv fade-in-right">
                        <iframe className="video-frame rounded-3xl shadow-custom w-full" src="https://www.youtube.com/embed/d3nmcELq4Sk?si=1XauK8D2DSTp-N2P"
                            frameBorder="0" allowFullScreen></iframe>
                    </div>
                </div>
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 lg:px-[100px] md:px-[60px] px-5 lg:py-[60px] md:py-[30px] py-5">
                    <div className="animation-iv fade-in-left">
                        <iframe className="video-frame rounded-3xl shadow-custom w-full" src="https://www.youtube.com/embed/d3nmcELq4Sk?si=1XauK8D2DSTp-N2P"
                            frameBorder="0" allowFullScreen></iframe>
                    </div>
            ...
            {/* Product */}
            <div className="bg-sapphire grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-7 md:gap-6 gap-5 lg:px-[100px] md:px-[60px] px-5 lg:py-[60px] md:py-[30px] py-5">
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in overflow-hidden rounded-xl bg-white">
                ...
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in overflow-hidden rounded-xl bg-white">
                    <div className="h-[450px] w-full overflow-hidden relative flex gap-0">
                        ...
                        <div className="absolute top-0 left-0 p-4 flex justify-between items-center w-full z-10">
                ...
                <div className="flex flex-col w-full justify-center items-center group cursor-pointer animation-iv fade-in overflow-hidden rounded-xl bg-white">
                    <div className="h-[400px] w-full overflow-hidden relative flex gap-0">
                        <img className="w-full h-full object-cover group-hover:-translate-x-full transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419325/files/parker-burchfield-tvG4WvjgsEY-unsplash_h48a95.jpg" />
                        <img className="w-full h-full object-cover group-hover:-translate-x-full transform transition-transform duration-500 ease-in-out" src="https://res.cloudinary.com/dvcdmxgyk/image/upload/v1718419325/files/luis-felipe-lins-J2-wAQDckus-unsplash_y9m8lq.jpg" />
                        <div className="absolute bottom-[-100%] group-hover:bottom-0 transform transition-all duration-500 ease-in-out left-0 p-4 flex justify-center items-center w-full">
                            <div className="flex overflow-hidden rounded-md shadow-lg bg-white">
