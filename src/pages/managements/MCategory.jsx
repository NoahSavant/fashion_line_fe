...
const MCategory = () => {
    ...
    useEffect(() => {
        ...
        setCategory({ ...category, name: '', image: null })
        setFetchCategory(true);
    }, [createCategoryData]);
            ...
            <div className='flex gap-5 lg:flex-row flex-col'>
                ...
                <div className='flex flex-col gap-2 p-4 rounded-md shadow-md bg-white w-full'>
                    ...
                    <div className='flex flex-col gap-4 items-end'>
                        ...
                        <div className='flex flex-col gap-1.5 w-full'>
                            <label>Image</label>
                            <UploadFile reset={true} className='w-full h-[135px]' values={category.image} number={1} setValues={(value) => setCategory({ ...category, image: value[0] })} />
                        </div>
