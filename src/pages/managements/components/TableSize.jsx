...
const TableSize = ({ items, dataLoading, handleSort, checkedKeys, setCheckedKeys, onEdit, onDelete, onMultyDelete, onCreate }) => {
        ...
        <div className='flex flex-col gap-2 w-full'>
            <div className='flex justify-between md:items-center items-start'>
                <div className='flex gap-2 items-center md:flex-row flex-col'>
                    <div className='text-lg font-semibold px-2'>Sizes</div>
            ...
            >
                ...
                <Column width={420} sortable>
                    <HeaderCell>Size Name</HeaderCell>
