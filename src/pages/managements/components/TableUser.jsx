...
import { UserStatus, Gender } from '@/constants';
import {
    BaseCell,
    ConstantCell,
    ActionCell,
...
const TableUser = ({ items, dataLoading, handleSort, checkedKeys, setCheckedKeys, onEdit, onDelete, onCreate, onMultyDelete, onSelect, height = 400 }) => {
        ...
        <div className='flex flex-col gap-2 w-full'>
            <div className='flex justify-between md:items-center items-start'>
                <div className='flex gap-2 items-center md:flex-row flex-col'>
                    <div className='text-lg font-semibold px-2'>Users</div>
            ...
            >
                ...
                <Column width={300} fullText sortable>
                    ...
                    <UserCell dataKeys={['username']} images={['image_url']}/>
                </Column>
                <Column width={300} fullText sortable>
                ...
                <Column width={150} sortable>
                    <HeaderCell className='text-center'>Gender</HeaderCell>
                    <ConstantCell dataKey="gender" constant={Gender} colors={['blue', 'pink']} />
                </Column>
                ...
                <Column width={100} sortable>
                    ...
                    <ConstantCell dataKey="status" constant={UserStatus} colors={['green', 'red']} />
                </Column>
