...
const TableBlog = ({ items, dataLoading, handleSort, checkedKeys, setCheckedKeys, onEdit, onDelete, onCreate, onMultyDelete, onSelect, height = 400 }) => {
        ...
        <div className='flex flex-col gap-2 w-full'>
            <div className='flex justify-between md:items-center items-start'>
                <div className='flex gap-2 items-center md:flex-row flex-col'>
                    <div className='text-lg font-semibold px-2'>Blogs</div>
            ...
            >
                ...
                <Column width={400}>
                    ...
                    <BaseCell dataKey="short_description" />
                </Column>
                <Column width={200} sortable>
                    <HeaderCell className='text-center'>Status</HeaderCell>
                    <ConstantCell dataKey="status" constant={BlogStatus} colors={['green', 'red']} />
                </Column>
