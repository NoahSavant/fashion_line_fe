    ...
    const MainTabs = ({vertical = false}) => {
        ...
        return (
            <Nav className={className} onSelect={(vertical) => {
                ...
                <Nav.Item className="px-6" eventKey="/policies" active={activeKey('/policies')} onClick={() => navigate('/policies')} icon={<IoMdContacts />}>Chính sách</Nav.Item>
            </Nav>
        );
    }
    ...
    return (
        <div className='relative'>
            <div className="fixed bottom-0 right-0 p-[24px] gap-4 z-50 flex flex-col">
                ...
                <a href="tel:0123456789" className="p-btn cursor-pointer h-[44px] w-[44px] bg-sapphire rounded-full justify-center items-center flex shadow-custom">
                ...
                <a href="https://m.me/100071853580727" target="_blank" className="p-btn cursor-pointer h-[44px] w-[44px] bg-sapphire rounded-full justify-center items-center flex shadow-custom">
