    ...
    return (
        <div className='relative'>
            <div className="fixed bottom-0 right-0 p-[24px] gap-4 z-50 flex flex-col">
                <div onClick={scrollToTop} className={`cursor-pointer h-[44px] w-[44px] bg-sapphire rounded-full justify-center items-center flex shadow-custom transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`} >
                ...
                <a href="tel:<?php echo get_theme_mod('phone') ?>" className="cursor-pointer h-[44px] w-[44px] bg-sapphire rounded-full justify-center items-center flex shadow-custom">
                ...
                <a href="https://m.me/A2BTax" target="_blank" className="cursor-pointer h-[44px] w-[44px] bg-sapphire rounded-full justify-center items-center flex shadow-custom">
